...
public class Database {
	...
	private static final String PASSWORD = "fdpdesql";
	...
	private void saveDefensiveEquipment (Connection con, int characterId, List<DefensiveEquipement> defensiveEquipement) {
	}
	...
	public void createHeros (Character player) {
		String sqlCharacter = """
